...
fund_master_list_df = pd.read_excel('')
databricks_df = pd.read_excel('')
...
databricks_df.to_excel('', sheet_name='EDL_TABLE', index=False)

with pd.ExcelWriter('', engine='openpyxl', mode = 'a') as writer:
