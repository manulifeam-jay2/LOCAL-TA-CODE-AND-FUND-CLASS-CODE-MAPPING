...
def get_unique_local_ta_code(df):
    return df['local_ta_code'].unique()
...
if __name__ == "__main__":
    ...
    edl_path = '/Users/urakodz/Downloads/DATA_MAPPING_CODE/LOCAL-TA-CODE-AND-FUND-CLASS-CODE-MAPPING/data-mapping/output.xlsx'
